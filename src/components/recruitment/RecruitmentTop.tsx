  ...
  return (
    ...
    >
      <Box sx={{ flex: 1, maxWidth: { md: "60ch" } }}>
        ...
        <Typography variant="h4" sx={{ color: theme.palette.primary.main, mb: 2, fontWeight: 700 }}>
      ...
      >
        <Box sx={{ width: { xs: "100%", md: 600 }, maxWidth: { md: 800 }, aspectRatio: "4/3", position: "relative" }}>
          <Image
            src="/welcome.png"
            alt="Recruitment"
            fill
    ...
    >
      <Typography
        variant="h3"
        sx={{ fontFamily: theme.typography.fontFamily, color: "common.white" }}
      >
